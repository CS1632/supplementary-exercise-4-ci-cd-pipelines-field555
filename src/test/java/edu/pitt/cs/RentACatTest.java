...
public class RentACatTest {
	...
	public void testGetCatNullNumCats0() {
		// TODO
		assertNull("getCat(2) returns a cat when there are no cats",r.getCat(2));
	}
	...
	public void testGetCatNumCats3() {
		...
		assertNotNull("getCat(2) returns null when there are 3 cats", c);
		assertEquals("getCat(2) does not return a cat with id 2", 2, c.getId());
	}
	...
	public void testCatAvailableTrueNumCats3() {
		...
		assertTrue("catAvailable(2) returns false when cat 2 is available", r.catAvailable(2));
	}
	...
	public void testListCatsNumCats0() {
		...
		assertEquals("listCats returns ''", "", r.listCats());
	}
	...
	public void testReturnCatNumCats3() {
		...
		// Mock that c2 is currently rented
		Mockito.when(c2.getRented()).thenReturn(true);
